...
inputUser = int(input("Input number between 0 and 4: "))
print(videoGames[inputUser-1])

inputGame = input("Input name: ")

if inputGame != videoGames:
  videoGames.append(inputGame)
else: 
  v
